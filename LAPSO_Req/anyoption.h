...
public: /* the public interface */
	...
	void useCommandArgs( int _argc, const char **_argv );
	...
	/*
         ...
         */
	void processCommandArgs( int _argc, const char **_argv );
	void processCommandArgs( int _argc, const char **_argv, int max_args );
...
private: /* the hidden data structure */
	...
	const char **argv;  	/* commndline args */
	const char* filename; 	/* the option file */
	const char* appname; 	/* the application name from argv[0] */
...
private: /* the hidden utils */
	...
	char parsePOSIX( const char* arg );
	int parseGNU( const char *arg );
